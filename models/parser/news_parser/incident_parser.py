...
def send_incident_news(message):
    """
    Эта функция получает последние новости о происшествиях с указанного URL и отправляет
    массив из первых 5 заголовков новостей вместе с их ссылками в функцию select_new().
    """
    url = 'https://ria.ru/incidents/'  # URL страницы с новостями о происшествиях
        ...
        if news_items:
            ...
            for news in news_items[:5]:
                ...
                if title_tag:
                    ...
                    news_array.append({'topic': 'Происшествия', 'title': title, 'link': absolute_link})
