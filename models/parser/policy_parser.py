...
def send_policy_news(message):
    """
    Эта функция получает последние новости о политике с указанного URL и отправляет
    массив из первых 5 заголовков новостей вместе с их ссылками в функцию select_new().
    """
    url = 'https://ria.ru/politics/'  # URL страницы с новостями политики
        ...
        if news_items:
            ...
            for news in news_items[:5]:
                ...
                if title_tag:
                    ...
                    news_array.append({'topic': 'Политика', 'title': title, 'link': absolute_link})
