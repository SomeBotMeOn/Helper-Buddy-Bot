...
def send_society_news(message):
    """
    Эта функция получает последние новости о обществе с указанного URL и отправляет
    массив из первых 5 заголовков новостей вместе с их ссылками в функцию select_new().
    """
    url = 'https://ria.ru/society/'  # URL страницы с новостями общества
        ...
        if news_items:
            ...
            for news in news_items[:5]:
                ...
                if title_tag:
                    ...
                    news_array.append({'topic': 'Общество', 'title': title, 'link': absolute_link})
